        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="mb-8 animate-fade-in">
            <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6 leading-tight">
              <span className="text-blue-500">3D</span> Stuff
            </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <Button 
              ...
              size="lg"
              className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-4 text-lg transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl"
            >
            ...
            <Button 
              ...
              className="border-2 border-gray-300 text-gray-700 px-8 py-4 text-lg hover:border-blue-500 hover:text-blue-500 transition-all duration-200"
            >
              Sobre nós
            </Button>
          </div>
